...
All UI components must be mobile-first and responsive. User experience takes priority in design decisions, with accessibility standards maintained throughout.
...
All authentication flows must use HTTPS in production. JWT tokens have appropriate expiration times. Passwords are never stored in plain text. Input validation prevents injection attacks.
